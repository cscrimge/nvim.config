  ...
  },
  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        vim.keymap.set('n', '<leader>hp', require('gitsigns').prev_hunk, { buffer = bufnr, desc = '[P]revious [H]unk' })
        vim.keymap.set('n', '<leader>hn', require('gitsigns').next_hunk, { buffer = bufnr, desc = '[N]ext [H]unk' })
...
require('telescope').setup {
  ...
  pickers = {
    lsp_references = { fname_width = 100, include_current_line = true, jump_type = 'never' },
  },
}
...
local function telescope_highlights()
  vim.api.nvim_set_hl(0, 'TelescopeMatching', { fg = '#dbbc7f', bold = true })
end
...
local on_attach = function(client, bufnr)
  ...
  if client and client.name == 'clangd' then
    nmap('<leader>ch', vim.cmd.ClangdSwitchSourceHeader, 'Clangd: Switch Source/Header')
  end
